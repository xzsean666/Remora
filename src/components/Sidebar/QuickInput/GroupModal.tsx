...
export const GroupModal: React.FC<GroupModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-2 sm:p-4 overflow-y-auto animate-fadeIn">
      <div className="bg-vscode-bg border border-vscode-border rounded-lg shadow-2xl w-full max-w-sm overflow-hidden flex flex-col max-h-[min(90vh,calc(100dvh-1rem))] my-auto">
        {/* Header */}
